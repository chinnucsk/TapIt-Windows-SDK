...
namespace TapIt_WP8_TestApp
{
    public partial class App : Application
    {
        ...
        public event EventHandler App_Deactivated;

        // Declare an event for when the application data changes.
        public event EventHandler App_Activated;

        // Create a method to raise the ApplicationDataObjectChanged event.
        protected void OnApplicationDeactivated(EventArgs e)
        {
            EventHandler handler = App_Deactivated;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        // Create a method to raise the ApplicationDataObjectChanged event.
        protected void OnApplicationActivated(EventArgs e)
        {
            EventHandler handler = App_Activated;
            if (handler != null)
            {
                handler(this, e);
            }
